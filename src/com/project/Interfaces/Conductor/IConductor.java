 ...
 */
package com.project.Interfaces.Conductor;
...
public class IConductor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jlblConductor.setBackground(new java.awt.Color(255, 255, 255));
        jlblConductor.setFont(new java.awt.Font("Roboto", 1, 36)); // NOI18N
        jlblConductor.setForeground(new java.awt.Color(0, 0, 0));
        jlblConductor.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlblConductor.setText("Conductor");
        jlblConductor.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        jpnlPrincipal.add(jlblConductor, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 460, 328, 60));
    ...
    private void jlblCerrarSesionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jlblCerrarSesionMouseClicked
        try {
            ...
            Logger.getLogger(IConductor.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        try {
            Utils.iniciarJframe(new IConductor(false));
        } catch (SQLException ex) {
            Logger.getLogger(IConductor.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
